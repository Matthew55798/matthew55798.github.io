...
## [#](#_1-apiencrypt-注解) 1. @ApiEncrypt 注解
...
[HTTP 接口签名（防篡改）](https://cloud.iocoder.cn/http-sign/) [单元测试](https://cloud.iocoder.cn/unit-test/)
