...
| `POST /auth/register/device` | [设备动态注册（一型一密）](https://cloud.iocoder.cn/iot/device-register/) | IotCoapRegisterHandler | 无 |
| `POST /auth/register/sub-device/:productKey/:deviceName` | [子设备动态注册](https://cloud.iocoder.cn/iot/device-register/) | IotCoapRegisterSubHandler | Token |
...
[设备接入（WebSocket 协议）](https://cloud.iocoder.cn/iot/protocol-websocket/) [设备接入（Modbus Client 模式）](https://cloud.iocoder.cn/iot/protocol-modbus-client/)
