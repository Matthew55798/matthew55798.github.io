...
[2.1 新增协议类型](#_2-1-新增协议类型)

[2.2 创建协议配置类](#_2-2-创建协议配置类)

[2.3 实现 IotProtocol 接口](#_2-3-实现-iotprotocol-接口)

[2.4 实现上行 Handler](#_2-4-实现上行-handler)

[2.5 实现下行 Subscriber](#_2-5-实现下行-subscriber)

[2.6 注册到 IotProtocolManager](#_2-6-注册到-iotprotocolmanager)

[2.7 添加 YAML 配置](#_2-7-添加-yaml-配置)

[附录](#附录)

[A. 关键服务一览](#a-关键服务一览)

[B. 短连接 vs 长连接](#b-短连接-vs-长连接)
...
* [《设备接入（概述）》](https://cloud.iocoder.cn/iot/protocol-overview/) — 建议先阅读，了解整体架构和消息格式
...
### [#](#_2-3-实现-iotprotocol-接口) 2.3 实现 IotProtocol 接口
...
### [#](#_2-4-实现上行-handler) 2.4 实现上行 Handler
...
### [#](#_2-5-实现下行-subscriber) 2.5 实现下行 Subscriber
...
### [#](#_2-6-注册到-iotprotocolmanager) 2.6 注册到 IotProtocolManager
...
### [#](#_2-7-添加-yaml-配置) 2.7 添加 YAML 配置
...
[设备接入（Modbus Server 模式）](https://cloud.iocoder.cn/iot/protocol-modbus-server/) [场景联动](https://cloud.iocoder.cn/iot/scene-rule/)
