...
[2.1 regex 正则脱敏](#_2-1-regex-正则脱敏)

[2.2 slider 滑块脱敏](#_2-2-slider-滑块脱敏)

[3. 自定义脱敏注解](#_3-自定义脱敏注解)

[4. 脱敏工具类](#_4-脱敏工具类)

[5.1 基于角色判断](#_5-1-基于角色判断)

[5.2 基于权限判断](#_5-2-基于权限判断)
...
[Webhook（钉钉、飞书、企微）](https://cloud.iocoder.cn/webhook/) [敏感词](https://cloud.iocoder.cn/sensitive-word/)
