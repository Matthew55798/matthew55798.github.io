...
[1. RPC 使用规约](#_1-rpc-使用规约)

[1.1 API 前缀](#_1-1-api-前缀)

[1.2 API 权限](#_1-2-api-权限)

[1.3 API 全局返回](#_1-3-api-全局返回)

[1.4 用户传递](#_1-4-用户传递)

[2. 如何定义一个 API 接口](#_2-如何定义一个-api-接口)

[2.1 服务提供者](#_2-1-服务提供者)

[2.2 服务消费者](#_2-2-服务消费者)
...
[服务网关 Spring Cloud Gateway](https://cloud.iocoder.cn/gateway/) [定时任务 XXL Job](https://cloud.iocoder.cn/job/)
