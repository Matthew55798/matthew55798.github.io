...
[2.1 全局工具类](#_2-1-全局工具类)

[2.2 项目专属工具类](#_2-2-项目专属工具类)
...
字典枚举配合字典工具类使用，详见 [字典数据](https://cloud.iocoder.cn/vben5/dict) 章节。
...
[系统组件](https://cloud.iocoder.cn/vben5/components/) [配置读取](https://cloud.iocoder.cn/vben5/config-center/)
