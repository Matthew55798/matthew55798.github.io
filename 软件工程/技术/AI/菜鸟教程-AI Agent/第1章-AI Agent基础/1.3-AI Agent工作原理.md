---
title: 1.3 AI Agent 工作原理
---

> 来源：[菜鸟教程 AI Agent 工作原理](https://www.runoob.com/ai-agent/ai-agent-working-principle.html)
...
![AI Agent 核心组件](/img/技术/ai-agent/ai-agent-core-runoob-3-scaled.png)
...
```
用户 User → 思考 Reason (LLM推理) → 行动 Action (调用工具) → 观察 Observe (获取结果) → 记忆 Memory (存储上下文)
```
...
![Agent 架构](/img/技术/ai-agent/ai-agent-intro-runoob.png)
