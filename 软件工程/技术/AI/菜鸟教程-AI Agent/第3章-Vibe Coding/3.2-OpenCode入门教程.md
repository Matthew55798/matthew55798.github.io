> 来源：[菜鸟教程](https://www.runoob.com/ai-agent/opencode-coding-agent.html)
...
OpenCode 也提供桌面端应用，可直接从 [发布页面](https://github.com/anomalyco/opencode/releases) 或 [opencode.ai/download](https://opencode.ai/download) 下载。
