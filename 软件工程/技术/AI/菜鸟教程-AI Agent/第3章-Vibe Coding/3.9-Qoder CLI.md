> 来源：[菜鸟教程](https://www.runoob.com/ai-agent/qoder-cli.html)

# Qoder CLI

Qoder CLI 是一款类似 Claude Code 的命令行工具，支持在终端中完成各类操作，适用于开发、自动化脚本等多种场景。
...
如果还没账号，可以在 [https://qoder.com/](https://qoder.com/) 网页上先注册个账号领取免费 Pro，或使用 Google 或 GitHub 账号直接注册。
