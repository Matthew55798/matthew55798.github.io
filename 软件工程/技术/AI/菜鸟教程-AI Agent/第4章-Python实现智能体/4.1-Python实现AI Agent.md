> 来源：[菜鸟教程 - Python 实现 AI Agent](https://www.runoob.com/ai-agent/python-ai-agent.html)
...
![Python AI Agent](/img/技术/ai-agent/python-runoob-ai-agent.png)
...
![目录结构](/img/技术/ai-agent/bd43d684-a6db-4b22-b230-12471eb397b4.png)
...
这只是 AI Agent 世界的冰山一角。工业级框架如 **LangChain**、**AutoGen** 提供了更强大的工具集成、记忆管理、多 Agent 协作等功能。要深入探索，建议你继续学习后续章节。
