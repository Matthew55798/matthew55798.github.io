> 来源：[菜鸟教程 - AI Agent 问答实例](https://www.runoob.com/ai-agent/ai-agent-answer-demo.html)
...
![项目结构](/img/技术/AI Agent/c9d3b32d-c5a4-40dc-8556-8e952aa2303d.png)
...
![获取API Key](/img/技术/AI Agent/83536c84-3956-4679-ad14-99d53e697692-scaled.png)
...
本章节我们构建了一个基础的问答 Agent，并逐步添加了联网搜索能力。

通过阿里云百炼的 API，我们可以快速构建具有以下能力的 AI Agent：

1.  **基础问答**：理解用户问题并生成回答
2.  **对话历史**：保持多轮对话的连贯性
3.  **联网搜索**：获取实时信息的能力

这只是一个开始，后续章节将介绍更多高级功能，如工具调用、记忆系统等。
