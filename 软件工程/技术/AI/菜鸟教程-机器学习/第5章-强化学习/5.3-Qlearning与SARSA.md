> 来源: [强化学习 Q-learning 与 SARSA](https://www.runoob.com/ml/ml-qlearning-sarsa.html)
...
![](/img/技术/机器学习/1745664845676.png)

### 算法流程

![](/img/技术/机器学习/ml-qlearning-sarsa-runoob-1-scaled.png)
...
-   **Q-learning 使用**： `γ * max_a Q(s_{t+1}, a)`
...
| **学习目标** | 学习**最优策略**的 Q 函数 | 学习**执行策略**（如 ε-greedy）的 Q 函数 |
...
![](/img/技术/机器学习/c4d5ccf0-9506-46ae-a918-1982fa5cfe6f.png)
