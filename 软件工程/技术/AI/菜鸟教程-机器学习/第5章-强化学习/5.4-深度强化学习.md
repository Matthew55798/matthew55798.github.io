> 来源: [深度强化学习](https://www.runoob.com/ml/ml-deep-reinforcement-learning.html)
...
![](/img/技术/机器学习/ml-deep-reinforcement-learningx45.png)
...
7.  **价值函数 (Value Function)**
    ...
    -   **定义**：用于评估状态或状态-动作对的好坏。它代表了从当前状态（或执行当前动作后）开始，未来能获得的**预期累积奖励**。
...
![](/img/技术/机器学习/6f326e47-82f6-4333-810f-dd43c313753.png)
