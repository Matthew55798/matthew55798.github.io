> 来源：[菜鸟教程](https://www.runoob.com/ml/ml-common-network-types.html)
...
![常见网络类型](/img/技术/机器学习/1-aulv32ztn-fjqhj-ozg3-nseq.jpg)
...
![全连接网络](/img/技术/机器学习/04db36e0-2116-47d8-9514-1184be5828a0.png)

我们可以把它想象成一个极其密集的信息处理网络，数据从输入层进入，经过多个隐藏层的变换，最终从输出层得到结果。

![多层感知机](/img/技术/机器学习/1-3f-a77-m-lni-jtsg-zfh-yn-u0-q3-k5-dv4.webp)
...
![卷积神经网络](/img/技术/机器学习/04db36xxxe0-2116-47d8-9514-1184be5828a0.png)
...
![CNN示例](/img/技术/机器学习/cnn-banner.webp)
...
![循环神经网络](/img/技术/机器学习/1-i-jbb-infuz41j-ng-a-mpalcg.png)

### 核心思想：引入记忆机制

RNN 的核心在于其循环结构。网络在处理当前输入时，会结合当前的输入和**上一个时刻的隐藏状态**，共同决定当前的输出和传递给下一个时刻的隐藏状态。这就像你在阅读一句话时，理解当前单词的含义需要依赖前面读过的单词。

![RNN结构](/img/技术/机器学习/04db116-47d8-9514-1184be5828a0.png)
...
![GAN](/img/技术/机器学习/ml-6149-image025.jpg)
...
![GAN结构](/img/技术/机器学习/04db116-47d8-9514-1184323be5828a0.png)
