...
> 来源：https://www.runoob.com/ml/ml-logistic-regression.html
...
我们将使用 Scikit-learn 自带的 Iris 数据集。为了简化问题，我们只使用前两个特征，并将问题转化为二分类问题。
...
-   梯度下降法是常用的优化方法，用来更新模型参数。
-   Python中的`scikit-learn`库提供了简单易用的接口来实现逻辑回归。
